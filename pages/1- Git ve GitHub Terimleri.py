...
term_list = [
        {"term": "Git", "description": git},
        {"term": "GitHub", "description": github},
        {"term": "Repository (Depo)", "description": repo},
        {"term": "Commit", "description": commit},
        {"term": "Branch (Dal)", "description": branch},
        {"term": "Merge", "description": merge},
        {"term": "Pull Request", "description": pull_request},
        {"term": "Clone", "description": clone},
        {"term": "Fork", "description": fork },
        {"term": "Pull", "description": pull}
    ]
